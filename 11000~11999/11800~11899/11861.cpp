/*
[11861: Maximal Area](https://www.acmicpc.net/problem/11861)
...
struct SegTree {
  ...
  ll maxArea(ll q_start, ll q_end) {
    ...
    ll left_ret = maxArea(q_start, min_idx - 1);
    ll right_ret = maxArea(min_idx + 1, q_end);
