/*
  [3737: Cycles of Lanes](https://www.acmicpc.net/problem/10350)
...
struct BiconnectedComponent {
  ...
  BiconnectedComponent() {
    ...
    fill(color_count, color_count + MAX_V, 0);
  }
...
int main() {
  ...
  while(tc--) {
    ...
    bcc.perform();
    bcc.reset_color_count();

    cout << bcc.max_color_count() << "\n";
  }
}
