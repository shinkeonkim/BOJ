/*
[10090: Counting Inversions](https://www.acmicpc.net/problem/10090)

Tier: Platinum 5 
Category: data_structures, sorting, segtree, divide_and_conquer
*/
...
void solve() {
  ...
  SegTreeWithLazyProp segtree(n + 1);

  ll ans = 0;
  for(int i = n - 1; i > -1; i--) {
    ll crt = ar[i];
    ans += segtree.query(0, crt - 1);
    segtree.update(crt, 1);
  }
